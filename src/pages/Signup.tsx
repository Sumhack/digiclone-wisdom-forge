...
import { Brain, Mail, ArrowLeft, Upload, Shield, CheckCircle } from "lucide-react";
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Please verify your email and complete identity verification.",
      });
      setStep(2);
      setIsLoading(false);
    }, 1000);
  ...
  const handleFileUpload = (type: string) => {
    ...
    input.onchange = (e) => {
      ...
      if (file) {
        ...
        toast({
          title: "File uploaded",
          description: `${type === 'selfie' ? 'Selfie' : 'ID Document'} uploaded successfully.`,
        });
      }
    };
    input.click();
  ...
  const handleVerificationComplete = () => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome to DigiClone AI. Redirecting to dashboard...",
      });
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-serif font-bold mb-2">Create your account</h1>
          <p className="text-muted-foreground">Start building your digital clone today</p>
        </div>
        ...
        {step === 1 && (
          <Card className="border-0 shadow-lg">
            <CardHeader className="space-y-1 text-center">
              <CardTitle className="text-xl font-serif">Sign up for DigiClone AI</CardTitle>
              <CardDescription>
